(function(root, returnDatepicker) {
  ...
  */
  ...
  function Datepicker(selector, options) {
    ...
    listeners.forEach(e => { // Declared at the top.
      window.addEventListener(e, oneHandler.bind(instance));
		...
		calendar.parentNode.querySelector('.calendar__selected-date').innerHTML = `${dateSelected.getDay()} ${monthsSelected[dateSelected.getMonth()]} ${dateSelected.getFullYear()}`;
  ...
  function setElValues(instance) {
		...
		const month = instance.dateSelected.getMonth();
